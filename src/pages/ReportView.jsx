...
import FieldReport from '../components/ReportView/FieldReport'
...
export default function ReportView() {
  ...
  const totalSubmission = reportData?.submissionStatsData?.reduce((acc, cur) => acc + cur.value, 0)
  useEffect(() => {
  ...
  return (
    <div className={css(style.mainWrapper)}>
      <div className={css(style.headerWrapper)}>
        <span className={css(style.title)}>Analytics Report View</span>
