...
export default function SubmitBtn({ attr, buttonDisabled, handleReset, formID, fieldKey }) {
  console.log(fieldKey, attr)
  return (
    <div className={`fld-wrp fld-wrp-${formID} ${getCustomClsName(fieldKey, 'fld-wrp')}`} btcd-fld="submit">
      <div className={`btcd-frm-sub ${attr.align === 'center' && 'j-c-c'} ${attr.align === 'right' && 'j-c-e'} ${getCustomClsName(fieldKey, 'btcd-frm-sub')}`}>
        <button
