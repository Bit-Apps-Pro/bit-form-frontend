...
export const toolsList = [
  ...
  },
  {
    ...
    elm: {
      ...
      lbl: __('Rating'),
      opt: [
        { lbl: __('Option 1'), val: 1, img: `${bits.assetsURL}/../static/rating/star.svg` },
        { lbl: __('Option 2'), val: 2, img: `${bits.assetsURL}/../static/rating/star.svg` },
        { lbl: __('Option 3'), val: 3, img: `${bits.assetsURL}/../static/rating/star.svg` },
        { lbl: __('Option 4'), val: 4, img: `${bits.assetsURL}/../static/rating/star.svg` },
        { lbl: __('Option 5'), val: 5, img: `${bits.assetsURL}/../static/rating/star.svg` },
      ],
      valid: {},
      err: {},
      customClasses: {},
