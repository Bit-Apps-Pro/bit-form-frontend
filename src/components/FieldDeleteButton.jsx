...
const FieldDeleteButton = ({ placement, className, label, removeLayoutItem, fieldId }) => (
  <Downmenu place={placement || 'top'}>
    ...
    <div className="wdt-200">
      ...
      <div className="flx flx-c">
        ...
        <button onClick={() => removeLayoutItem(fieldId)} className="tip-btn red-btn" type="button">Delete</button>
      </div>
    </div>
  </Downmenu>
)
