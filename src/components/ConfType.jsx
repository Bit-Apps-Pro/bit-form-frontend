...
export default function ConfType(props) {
  ...
  return (
    <div className="btcd-f-c-t">
      ...
      <div>
        <button onClick={() => handlePos(0)} className={`btcd-f-c-t-o ${pos === 0 && 'btcd-f-c-t-o-a'}`} type="button">Same Page With a Message</button>
        <button onClick={() => handlePos(1)} className={`btcd-f-c-t-o ${pos === 1 && 'btcd-f-c-t-o-a'}`} type="button">Redirect to another Page</button>
        <button onClick={() => handlePos(2)} className={`btcd-f-c-t-o ${pos === 2 && 'btcd-f-c-t-o-a'}`} type="button"> Redirect to a Custom Link</button>
      </div>

      <div className="btcd-f-c-t-d">
        <div className="btcd-f-c-t-d-0" style={{ height: pos === 0 && 130 }}>
          <div className="f-m"><b>Success Message: </b></div>
          <textarea onChange={handleMsg} className="btcd-paper-inp" style={{ width: '95%' }} rows="5" value={msg} />
        </div>
        <div className="btcd-f-c-t-d-0" style={{ height: pos === 1 && 70 }}>
          <div className=""><b>Select A Page</b></div>
        ...
        <div className="btcd-f-c-t-d-0" style={{ height: pos === 2 && 70 }}>
          <div className="f-m"><b>Custom URL:</b></div>
          <input onChange={handleUrl} className="btcd-paper-inp" text="text" value={url} />
        </div>
      </div>
    </div>
  )
