...
export default function ThemeCustomize() {
  ...
  const genarateTitle = () => {
    switch (element) {
      ...
      case 'lbl-pre-i': return 'Label Leading Icons'
      case 'lbl-suf-i': return 'Label Trailing Icons'
      case 'sub-titl': return 'Sub Titles'
      case 'sub-titl-pre-i': return 'Subtitle Leading Icons'
      case 'sub-titl-suf-i': return 'Subtitle Trailing Icons'
      case 'pre-i': return 'Input Leading Icons'
      case 'suf-i': return 'Input Trailing Icons'
      case 'hlp-txt': return 'Helper Texts'
      case 'hlp-txt-pre-i': return 'Helper Text Leading Icons'
      case 'hlp-txt-suf-i': return 'Helper Text Trailing Icons'
      case 'err-msg': return 'Error Messages'
      case 'err-txt-pre-i': return 'Error Text Leading Icons'
      case 'err-txt-suf-i': return 'Error Text Trailing Icons'
      case 'btn': return 'Buttons'
      case 'btn-pre-i': return 'Button Leading Icons'
      case 'btn-suf-i': return 'Button Trailing Icons'
