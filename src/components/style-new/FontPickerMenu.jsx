...
export default function FontPickerMenu() {
  ...
  const findSelectedFontIndx = () => (styles?.font?.fontType === 'google' ? allFonts.items.findIndex(itm => itm.family === themeVars['--g-font-family']) : Number(0))
  ...
  console.log(findSelectedFontIndx())
