...
const themeVars = {
  ...
  '--global-fld-bdr': 'solid', // global field Border
  ...
  '--lbl-pre-i-m': '0p 5px 0px 0px', // label prefix icon margin
...
const themeColors = {
  ...
  '--global-fld-bdr-clr': 'hsla(0, 80%, 80%, 25)', // global field Border color
