...
function TextFieldSettings() {
  ...
  const predefinedPatterns = [
    ...
    { lbl: 'Name', val: '^[a-zA-Z .]+$', msg: 'Name cannot contain any number or special characters' },
    { lbl: 'Username', val: '^[a-z0-9_.]+$', msg: 'Username cannot contain any space or special characters' },
