...
export default function FileUpSettings(props) {
  ...
  return (
    <div>
      ...
      <DropDown title="Allowed File Type:" isMultiple addable options={options} placeholder="Any File Type" searchPH="Search or Add ext (e.g: .jpg,.png)" action={setFileFilter} value={exts} />
    </div>
  )
}
