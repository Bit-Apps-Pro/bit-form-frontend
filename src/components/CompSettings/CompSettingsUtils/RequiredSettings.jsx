...
export default function RequiredSettings() {
  ...
  return (
    ...
    >
      ...
      />
      <CheckBoxMini className={`${css(ut.mr2, { ml: 7 })} ${css(ut.fw500)} `} name="reqShow" checked={fieldData?.valid?.reqShow || false} title={__('Show Asterisk Symbol', 'bitform')} onChange={setReqShow} />
