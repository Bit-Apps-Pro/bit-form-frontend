                    ...
                    : (
                        <div className="flx flx-between mt-2">
                            <MultiSelect
                                ...
                                customValue
                            />
                            <button onClick={() => getAllGroups(mailerLiteConf, setMailerLiteConf, setIsLoading)} className="icn-btn sh-sm ml-2 mr-2 tooltip" style={{ '--tooltip-txt': `${__('Refresh Groups', 'bit-integrations')}'` }} type="button" disabled={isLoading}>&#x21BB;</button>
                        </div>
                    )}
