  ...
  return (
    <div style={{ width: 900 }}>
      ...
      <div className="flx mt-3">
        ...
        <input className="btcd-paper-inp w-7" onChange={e => handleInput(e, workDriveConf, setWorkDriveConf)} name="name" value={workDriveConf.name} type="text" placeholder={__('Integration Name...')} />
      </div>
      <br />
      <br />
