    ...
    >
      <div className="pos-rel flx">
        <div className="flx integ-fld-wrp">
          ...
          {field.formField === 'custom' && <MtInput onChange={e => handleCustomValue(e, i, elasticEmailConf, setElasticEmailConf)} label={__('Custom Value', 'bit-integrations')} className="mr-2" type="text" value={field.customValue} placeholder={__('Custom Value', 'bit-integrations')} />}
