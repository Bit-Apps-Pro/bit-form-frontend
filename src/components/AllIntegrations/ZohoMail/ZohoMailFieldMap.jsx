  ...
  return (
    <div className="flx flx-around mt-2 mr-1">
      <select
        ...
        onChange={(ev) => handleFieldMapping(ev, i, mailConf, setMailConf)}
      >
      ...
      {field.formField === 'custom' && (
        <MtInput
          onChange={e => handleCustomValue(e, i, mailConf, setMailConf)}
      ...
      <button
        onClick={() => delFieldMap(i, mailConf, setMailConf)}
