...
export default function ZohoMailIntegLayout({ formFields, mailConf, setMailConf }) {
  ...
  const handleInput = (e, typ) => {
    ...
    switch (typ) {
      case 'mailType':
        newConf.mailType = e.target.value
        break;
      case 'to':
        newConf.to = e
        break;
  ...
  return (
    <div style={{ width: 875 }}>
      <div className="flx">
        ...
        <select onChange={(e) => handleInput(e, 'mailType')} className="btcd-paper-inp" style={{ width: 150 }} value={mailConf.mailType}>
      ...
      <div className="mt-2 flx">
        ...
        <input type="text" onChange={(e) => handleInput(e, 'subject')} className="btcd-paper-inp w-7" placeholder="Email Subject Here" value={mailConf.subject || ''} />
