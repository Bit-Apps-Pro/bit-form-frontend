...
export default function ZohoAnalyticsFieldMap({ i, formFields, field, analyticsConf, setAnalyticsConf }) {
  return (
    ...
    >
      ...
      {field.formField === 'custom' && <MtInput onChange={e => handleCustomValue(e, i, analyticsConf, setAnalyticsConf)} label="Custom Value" className="mr-2" type="text" value={field.customValue} placeholder="Custom Value" />}
