  ...
  return (
    <div className="pos-rel">
      <div className="d-flx flx-wrp">
        ...
        <TableCheckBox onChange={openShareModal} checked={sheetConf?.actions?.share?.find(userShare => userShare.email) || false} className="wdt-200 mt-4 mr-2" value="user_share" title={__('Update google Sheet')} subTitle={__('Update Responses with Google Sheet?')} />
      </div>
