...
export default function FluentCrmActions({ fluentCrmConf, setFluentCrmConf, formFields }) {
  ...
  return (
    ...
    <div className="pos-rel d-flx w-8">
      ...
      <TableCheckBox checked={fluentCrmConf.actions?.double_opt_in || false} onChange={(e) => actionHandler(e, 'doubleOpIn')} className="wdt-200 mt-4 mr-2" value="double_opt_in" title={__('Double Op-in', 'bitform')} subTitle={__('Enable Double Option for new contacts', 'bitform')} />
    </div>
