  ...
  return (
    <div style={{ width: 900 }}>
      ...
      <div className="flx mt-3">
        ...
        <input className="btcd-paper-inp w-7" onChange={e => handleInput(e, fluentCrmConf, setFluentCrmConf)} name="name" value={fluentCrmConf.name} type="text" placeholder={__('Integration Name...', 'bitform')} />
      </div>
      <br />
      <br />
