...
export default function ZohoBiginRelatedRecord({ indx, tab, settab, formID, formFields, biginConf, setBiginConf, handleInput, isLoading, setisLoading, setSnackbar }) {
  ...
  return (
    <>
      ...
      <button onClick={() => refreshRelatedList(formID, biginConf, setBiginConf, setisLoading, setSnackbar)} className="icn-btn sh-sm ml-2 mr-2 tooltip" style={{ '--tooltip-txt': `'${__('Refresh Bigin Related Lists')}'` }} type="button" disabled={isLoading}>&#x21BB;</button>
      <br />
      <br />
      {isLoading && (
        <Loader style={{
