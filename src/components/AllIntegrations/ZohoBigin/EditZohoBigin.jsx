  ...
  return (
    <div style={{ width: 900 }}>
      ...
      <div className="flx mt-3">
        ...
        <input className="btcd-paper-inp w-7" onChange={event => handleInput(event, tab, biginConf, setBiginConf)} name="name" value={biginConf.name} type="text" placeholder="Integration Name..." />
      </div>
      <br />
      <br />
