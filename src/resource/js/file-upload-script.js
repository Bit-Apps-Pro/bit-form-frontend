...
export default class FileUploadField {
  ...
  init() {
    ...
    const {
      multiple, allowedFileType, accept, required, showMaxSize, maxSize, sizeUnit, showSelectStatus, fileSelectStatus,
    } = this.#config
  ...
  #fileUploadAction(e) {
    ...
    const {
      sizeUnit, maxSize, isItTotalMax, multiple, showFileList, showFilePreview, showFileSize, showSelectStatus, fileSelectStatus, minFile, maxFile,
    } = this.#config
