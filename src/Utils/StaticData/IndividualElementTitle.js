...
export const getElementTitle = (element) => {
  switch (element) {
    ...
    case 'option-list': return 'Option List'
    ...
    case 'inp-fld-wrp': return 'Input Fields Wrapper'
    case 'rpt-wrp': return 'Repeatative Wrapper'
    case 'rpt-grid-wrp': return 'Grid Wrapper'
    case 'pair-btn-wrp': return 'Button Wrapper'
    case 'rpt-add-btn': return 'Add Button'
    case 'rpt-add-btn-pre-i': return 'Add Button Leading Icon'
    case 'rpt-add-btn-suf-i': return 'Add Button Trailing Icon'
    case 'rpt-rmv-btn': return 'Remove Button'
    case 'rpt-rmv-btn-pre-i': return 'Remove Button Leading Icon'
    case 'rpt-rmv-btn-suf-i': return 'Remove Button Trailing Icon'
    case 'add-to-end-btn-wrp': return 'Add To End Button Wrapper'
