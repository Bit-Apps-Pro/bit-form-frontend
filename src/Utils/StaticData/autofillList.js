const autofillList = [
  { label: 'Off', value: 'off', type: 'general' },
  { label: 'On', value: 'on' },
  { label: 'Name', type: 'group_start' },
  { label: 'Name', value: 'name' },
  { label: 'honorific-prefix', value: 'honorific-prefix' },
  { label: 'Give name', value: 'given-name' },
  ...
  { label: 'Cc exp yeat', value: 'cc-exp-year' },
  { label: 'Cc cse', value: 'cc-csc' },
  { label: 'Cca type', value: 'cc-type' },
  { label: 'Transaction currency', value: 'transaction-currency' },
  { label: 'Transaction account', value: 'transaction-amount' },
  { label: 'Language', value: 'language' },
  { label: 'Birth day', value: 'bday' },
  { label: 'Bday day', value: 'bday-day' },
  { label: 'Dday month', value: 'bday-month' },
  { label: 'Telephone', type: 'group_start' },
  { label: 'Telephone', value: 'telephone' },
  { label: 'Tel national', value: 'tel-national' },
  { label: 'Sex', value: 'sex' },
  { label: 'Tel Counrty code', value: 'tel-country-code' },
